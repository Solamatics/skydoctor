                    ...
                    <CardContent sx={{ pb: 2, pt: 3 }}>
                      <Box sx={{ display: "flex", flexDirection: "row" }}>
                        ...
                        <div style={{ padding: "10px 15px 10px" }}>
                          ...
                          <h5 className={"dash-cards-content"}>
                            {item.subContent}
                          </h5>
                        </div>
                      </Box>
                      <Box sx={{ textAlign: "right", mt: -1 }}>
                        <Typography
                          component={"span"}
                          className={"dash-cards-summary"}
                        >
                          {item.status >= 1 ? (
                            <ExpandLess
                              fontSize={"small"}
                              sx={{ mb: -0.5, mr: 0.2, color: "#10916F" }}
                            />
                          ) : (
                            <ExpandMore
                              fontSize={"small"}
                              sx={{ mb: -0.5, mr: 0.2, color: "#FF0202" }}
                            />
                          )}
                          <span
                            style={{
                              color: item.status >= 1 ? "#10916F" : "#FF0202",
                              marginRight: "2px",
                            }}
                          >
                            {item.summary}
