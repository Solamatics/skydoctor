...
const EditPrescription = () => {
    const [prescription, AddPrescription] = useState([
        {name: 'Amoxapine', quantity: '2', days: '2 Days', morning: false, afternoon: false, evening: false, night: false},
        {name: 'Benazepril', quantity: '2', days: '2 Days', morning: false, afternoon: false, evening: false, night: false},
    ])
    const addMore = () => {
        const prescription = {
            name: '',
                                                ...
                                                <table className="table table-hover table-center">
                                                    ...
                                                    <tbody>
                                                    {
                                                        prescription.map((item, index) => (
                                                            <tr>
                                                                <td>
                                                                    <input  value={item.name} className="form-control" name={'name'}
                                                                           type="text"/>
                                                                </td>
                                                                <td>
                                                                    <input value={item.quantity} className="form-control" name={'quantity'}
                                                                           type="text"/>
                                                                </td>
                                                                <td>
                                                                    <input value={item.days} className="form-control" name={'days'}
                                                                           type="text"/>
                                                                </td>
                                                                <td>
