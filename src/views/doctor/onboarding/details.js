...
import {EditOffRounded, EmailOutlined, ImageSearch, Visibility, VisibilityOff,} from "@mui/icons-material";
...
export default function Details({userDetails,updatePage}) {
    ...
    return (
        <Box sx={{mt: {xs: 2, sm: 10},padding:{xs:'20px',sm:'50px'}, minHeight: {xs: '100%', sm: '580px'}}} className={'onboarding-content-box'}>
            ...
            <h6 className={'onboarding-title'}>Personalize Your Profile <span style={{color: '#FF0202'}}>*</span></h6>
                    ...
                    <Grid container spacing={3} rowSpacing={{xs: 1, sm: 1}}>
                        <Grid item xs={12} sm={12} lg={12} md={12}>
                                        ...
                                        ? <Typography
                                            ...
                                            <div className={'w3-text-center w3-center '} style={{marginTop: '5px'}}>
                                                <span style={{
                                                    color: '#A8A8A8',
                                                    fontSize: '10px'
                                                }}>{FileSize(formik.values.avatar.size)}</span>
                                            </div>
                            ...
                            <span
                                ...
                                style={{
                                    display: formik.touched.avatar && Boolean(formik.errors.avatar) ? 'block' : 'none'
                                }}>
                                {formik.touched.avatar && formik.errors.avatar}
                            </span>
                            <div className={'photo-norms'}>
                                <h5>Logo Should be minimum 152 * 152 Supported File format JPG,PNG,SVG</h5>
                            </div>

                        </Grid>
                        <Grid item xs={12} sm={12} lg={12} md={12}>
                            <div>
                                <label className={'form-label'}>Legal Name <span
                                    style={{color: '#FF0202'}}>*</span></label>
                                <TextField
                                    margin={'normal'}
                                    type={'text'}
                                    required
                        ...
                        <Grid item xs={12} sm={6} lg={6} md={6}>
                            <div>
                                <label className={'form-label'}>Gender<span style={{color: '#FF0202'}}>*</span></label>
                                <Autocomplete
                                    fullWidth
                                    renderInput={(params) =>
                                        <TextField
                        ...
                        <Grid item xs={12} sm={6} lg={6} md={6}>
                            <div>
                                <label className={'form-label'}>Date of Birth <span style={{color: '#FF0202'}}>*</span></label>
                                <TextField
                                    margin={'normal'}
                                    type={'date'}
                                    required
                        ...
                        <Grid item xs={12} sm={6} lg={6} md={6}>
                            <div>
                                <label className={'form-label'}>City <span style={{color: '#FF0202'}}>*</span></label>
                                <TextField
                                    margin={'normal'}
                                    type={'text'}
                                    required
                        ...
                        <Grid item xs={12} sm={6} lg={6} md={6}>
                            <div>
                                <label className={'form-label'}>State<span style={{color: '#FF0202'}}>*</span></label>
                                <Autocomplete
                                    fullWidth
                                    renderInput={(params) =>
                                        <TextField
                        ...
                        <Grid item xs={12} sm={12} lg={12} md={12}>
                            <div>
                                <label className={'form-label'}>About you <span
                                    style={{color: '#FF0202'}}>*</span></label>
                                <TextField
                                    margin={'normal'}
                                    type={'text'}
