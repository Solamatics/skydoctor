            ...
            <div className="invoice-container">
                <div className="row">
                    <div className="col-sm-6 mb-4">
                        <img alt="Logo" className="inv-logo img-fluid" src={require("../../../assets/img/logo.png")}/>
                    </div>
                ...
                <div className="row">
                    <div className="col-sm-6 col-lg-7 col-xl-8 mb-4">
                        ...
                        <ul className="list-unstyled mb-0">
                            ...
                            <li>United States</li>
                            <li>8286329170</li>
                            <li><a href="#"><span className="__cf_email__"
                                                  data-cfemail="4a29222b38262f242f382f2f2e0a2f322b273a262f64292527">[email&#160;protected]</span></a>
                            </li>
                        </ul>
                    </div>
                ...
                <div className="table-responsive">
                    <table className="table table-borderless hover-table">
                        ...
                        <tr>
                            <td>1</td>
                            <td>medicine1</td>
                            <td className="d-none d-sm-table-cell">Lorem ipsum dolor sit amet, consectetur adipiscing
                                elit
                            </td>
                            <td>$10</td>
                            <td>2</td>
                ...
                <div>
                    ...
                    <div className="invoice-info">
                        ...
                        <p className="text-muted mb-0">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Vivamus
                            sed
