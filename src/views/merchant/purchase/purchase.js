...
import DelPurchaseDialog from "./delPurchaseDialog";
...
export default function Purchase() {
    ...
    return (
        <>
                                                ...
                                                <tr>
                                                    ...
                                                    <td className="text-end">
                                                        <div className="actions">
                                                            <Link to={'/merchant/edit-purchase'} className="text-black">
            ...
            <DelPurchaseDialog dialog={delDialog} setDialog={setDelDialog} />
        </>
