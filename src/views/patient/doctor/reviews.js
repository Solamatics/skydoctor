            ...
            <div className="widget review-listing">
                <ul className="comments-list">
                    ...
                    <li>
                        <div className="comment">
                            ...
                            <div className="comment-body">
                                ...
                                <p className="recommended"><i
                                    className="far fa-thumbs-up"></i> I recommend the
                                    doctor</p>
                            ...
                            <li>
                                <div className="comment">
                                    <img className="avatar avatar-sm rounded-circle"
                                         alt="User Image"
                                         src={require("../../../assets/img/patients/patient1.jpg")}/>
                                    <div className="comment-body">
                                        <div className="meta-data">
                                                                    <span
                                                                        className="comment-author">Charlene Reed</span>
                                            <span
                    ...
                    <li>
                        <div className="comment">
                            <img className="avatar avatar-sm rounded-circle" alt="User Image"
                                 src={require("../../../assets/img/patients/patient2.jpg")}/>
                            <div className="comment-body">
                                <div className="meta-data">
            ...
            <div className="write-review">
                ...
                <form>
                    ...
                    <div className="submit-section">
                        <button type="submit" className="btn btn-primary submit-btn">Add
                            Review
                        </button>
                    </div>
                </form>
