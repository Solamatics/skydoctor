...
import {getCategories, getCountries, RegisterUser, updateRegDetails} from "../../../store/authStore";
...
export  default function RegistrationForm({updateReg}) {
    ...
    const validationSchema = yup.object({
        ...
        password: yup
            ...
            .matches(/^(?=.*[A-Za-z])(?=.*\d)(?=.*[@$!%*#?&_()-+=])[A-Za-z\d@$!%*#?&_()-+=]{8,}$/, {message: 'Invalid password format'}),
            ...
            <Box sx={{display:'block'}}>
                ...
                <form noValidate aria-autocomplete={'none'} autoComplete={'off'} onSubmit={formik.handleSubmit}>
                    ...
                    <Autocomplete
                        ...
                        isOptionEqualToValue={(option, stateInput) => option.id === stateInput.id}
                    ...
                    <Box>
                        ...
                        <div className={'w3-text-right'} style={{textAlign: 'right'}}>
                            <Typography sx={{fontSize: '12px', mt: 1}}>
                                ...
                                <Link to={'/'} style={{color: '#00329B'}}> Sign In</Link>
                            </Typography>
                        </div>
                        <br/>
