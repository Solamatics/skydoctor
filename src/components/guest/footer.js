...
export default function Footer(){
    return (
        <Box component={'footer'} sx={{padding: '20px 0 0',backgroundColor: '#00329B',  }}>
                ...
                <Grid item xs={12} sm={6} lg={5} md={5} >
                    ...
                    <div>
                        ...
                        <Typography sx={{color:'white', fontSize:'14px', lineHeight:2}} component={'p'}>
                            ...
                            Booking and consultation Services for Doctors and Patients, ecommerce and Marketplace Solutions to consumers and wholesalers.
                        </Typography>
                        <br/>
                        {
                            social.map(item=>(
